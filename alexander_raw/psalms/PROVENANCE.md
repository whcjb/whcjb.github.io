...
| 外文与希伯来活字残渣 | 635 |
| 待判·证人还有话说 | 72 |
| 待判·证人对不上（锚撞车，读数离谱） | 44 |
| 待判·无证据（锚在证人语料里找不到落点） | 40 |

真正待判 156 处（0.046%），其中后两档共 84 处只剩影像一条路。**待判要分档报**：
先前报过「382 处待判」，把锚撞车那批算了进去——它们要判，但证人这条路已经
走到头，跟「证人还有话说」不是一种工作量；反过来把它们摘出分母也不对。

后两档在以赛亚书那边同名不同义：那本书九份证人，「无证据」是票散了（多数
表决的前置过滤起作用的痕迹）；诗篇单证人，「无证据」是**锚在 1850 三卷本里
根本没有落点**——两版之间那句被改写过，或者锚里的词全崩了。
