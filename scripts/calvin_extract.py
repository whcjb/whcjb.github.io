...
VOLUMES = {
    ...
    'hosea':           { 'format': 'ages_phil', 'pdf': '/Users/yanpeifa/Documents/论文/calvin/CAL_HOSE.pdf',
        'latin_x_min': 'auto', 'out': os.path.join(BASE, 'calvin_raw/hosea/calvin_hosea_structured.txt') },
