...
PLAN_GUIDE = (
    ...
    "G. 清晰优先: 文白相济但**以清楚达意为先**, 不为求文雅而过度压缩到指代不清或歧义"
    "(反例「它们本欲人全然归向」——指代不清且臆加「欲」); 被动/情态要译准: "
    "designed/ordained to be→本当/受命, ought→当, 勿擅加原文没有的「欲/使/想要」。\n"
    "H. 代词明确: 「它/它们/其」若指代不清, 改用所指的名词, 勿留悬空代词。"
)
