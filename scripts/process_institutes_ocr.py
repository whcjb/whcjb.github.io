...
CHAPTERS = {
    ...
    2: [
        ...
        (2,  349, 382, "人已完全丧失自由选择而悲惨地作罪的奴仆"),
        (3,  383, 403, "出自人败坏本性的一切都是神所憎恶的"),
        (4,  404, 411, "神如何在人心里运行"),
        (5,  412, 436, "反驳对自由意志最普遍的辩护"),
        (6,  437, 444, "堕落之人要寻求在基督里的救赎"),
        (7,  445, 463, "神给以色列人他的律法，并不是要约束他们，而是要在基督降临前给他们救恩的盼望"),
        (8,  464, 519, "道德律的解释（十诫）"),
        (9,  520, 525, "虽然犹太人在律法时代认识基督，但基督到了福音时代才被清楚地启示"),
        (10, 526, 546, "旧约与新约的相似之处"),
        (11, 547, 561, "新、旧约之间的区别"),
        (12, 562, 572, "基督为了担任中保的职分必须降世为人"),
        (13, 573, 580, "基督取得人真实的肉体"),
        (14, 581, 593, "中保的神性和人性如何成为一个人格"),
        (15, 594, 603, "为了明白父神差遣基督的目的，即基督所赏赐我们的，最主要的是必须查考基督的三种职分：先知、君王、祭司"),
        (16, 604, 629, "基督如何担任救赎者的职分并为我们获得救恩。对基督的死、复活和升天的讨论"),
        (17, 630, 637, "我们说基督的功劳使我们获得神的恩典和救恩是恰当的，也是正确的"),
    ],
    3: [
        # ── yaoyi2.pdf 第三卷正文 ──
        (1,   9,  14, "圣经记载关于基督的事是借圣灵隐秘的运行使我们获益"),
        (2,  15,  65, "信心的定义和其性质的解释"),
        (3,  66,  95, "借着信心重生：悔改"),
        (4,  96, 143, "经院神学家们对悔改的谬论与纯正的福音截然不同——论认罪和赎罪"),
        (5, 144, 158, "他们在赎罪上添加赎罪券和炼狱"),
        (6, 159, 164, "基督徒的生活；首先，圣经如何劝我们这样行"),
        (7, 165, 177, "基督徒生活的总结：自我否定"),
        (8, 178, 188, "背十字架，自我否定的一部分"),
        (9, 189, 196, "对永世的默想"),
        (10, 197, 203, "信徒应当如何使用今世和其中的福分"),
        (11, 204, 233, "因信称义的定义"),
        (12, 234, 243, "我们必须仰望神的审判台，使我们能确信神对我们白白的称义"),
        (13, 244, 250, "关于白白称义有两件值得我们留意的事"),
        (14, 251, 271, "称义的起始和不间断的过程"),
        (15, 272, 281, "以自己的功德自夸，毁坏我们因称义所应归给神的称赞，也破坏我们蒙救恩的确据"),
        (16, 282, 287, "反驳天主教徒用来侮辱这教义的异议"),
        (17, 288, 307, "律法上的应许和福音彼此合一"),
        (18, 308, 321, "人将得奖赏并不能证明人是因行律法称义"),
        (19, 322, 338, "基督徒的自由"),
        (20, 339, 411, "祷告是信心主要的行动，也是我们天天领受神恩赐的方式"),
        (21, 412, 424, "神在他永恒的拣选中预定一些人蒙救恩，也预定其他人遭灭亡"),
        (22, 425, 441, "圣经对于拣选教义见证上的确认"),
        (23, 442, 460, "反驳这教义常遭到的错误指控"),
        (24, 461, 485, "神的呼召证明他的拣选，且恶人应得神所预定他们公正的灭亡"),
        (25, 486, 508, "最后的复活"),
    ],
    4: [
        # ── yaoyi3.pdf（下册）──
